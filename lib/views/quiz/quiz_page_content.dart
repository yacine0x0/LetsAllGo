...
class _QuizPageContentState extends State<QuizPageContent> {
  ...
  // ✅ CORRECTION — envoyer chapterName
Future<void> _submitAndComplete() async {
  ...
  Widget _buildCompletionScreen(double h, double w) {
    ...
    if (percentage >= 80) {
      message = _lang.t(
          "Excellent ! Tu es un pro ! 🎉", "Excellent! You're a pro! 🎉");
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                            _lang.t("Quiz terminé !", "Quiz Completed!"),
                            style: TextStyle(
                                color:      Colors.white,
                                fontSize:   h * 0.04,
                                fontWeight: FontWeight.bold)),
      ...
      children: [
        Row(
          ...
          children: [
            Text(
                _lang.t(
                    "Progression du quiz", "Course progression"),
                style: TextStyle(
          ...
          child: AnimatedContainer(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                    _lang.t("Vérifier la réponse", "Check Answer"),
                    style: TextStyle(
                        color:         canCheck
                            ? Colors.white
                            : Colors.white38,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text(
                        _lang.t(
                            "Score de la session", "Session Score"),
                        style: TextStyle(
                            color:    Colors.white54,
                            fontSize: h * 0.012)),
                    Text(
