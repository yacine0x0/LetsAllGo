...
class Algo2QuizController implements BaseQuizController {
  ...
  static const Map<String, String> _chapterIcons = {
    'Chapitre 01': 'assets/images/icons_algo2/data_structure_icone.png',
  ...
  static Future<List<Question>> _loadQuestionsFromXml(String chapter) async {
    ...
    try {
      ...
      print('❌ Algo2: impossible de charger $path → $e');
      return [];
    }
    ...
    for (final chapter in selectedChapters) {
      ...
      quizzes.add(Quiz(
        ...
        icon:      _chapterIcons[chapter] ??
                   'assets/images/icons_algo2/data_structure_icone.png',
        questions: selected,
      ));
    }
